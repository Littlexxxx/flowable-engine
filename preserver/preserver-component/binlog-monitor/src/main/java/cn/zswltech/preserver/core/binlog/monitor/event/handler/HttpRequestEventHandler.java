...
//    }
//
//    private void post(String param) throws BinlogMonitorRuntimeException {
...
//                        throw new BinlogMonitorRuntimeException("http request failed.code:" + response.getStatusLine().getStatusCode());
//                    }
...
//                response.close();
//            } catch (IOException e) {
//                throw new BinlogMonitorRuntimeException(e.getMessage(),e);
//            }
//        }
//    }
//}
