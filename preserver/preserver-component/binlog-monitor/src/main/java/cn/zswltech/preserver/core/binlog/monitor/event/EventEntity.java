...
public class EventEntity {
    ...
    // TODO 获取keys
    List<TableMetaEntity.ColumnMetaData> keys;
    ...
    public List<TableMetaEntity.ColumnMetaData> getKeys() {
        return keys;
    }

    public void setKeys(List<TableMetaEntity.ColumnMetaData> keys) {
        this.keys = keys;
    }
